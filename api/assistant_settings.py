"""
Конфигурация AI Assistant (env-переменные).
...
# ============================================================================
# Настройки гибридного поиска (BM25 + семантика)
# ============================================================================

# Количество кандидатов для re-ranking (до финального top_k)
RAG_RERANK_TOP_N = env.int('RAG_RERANK_TOP_N', default=20)

# Включить cross-encoder re-ranking через Ollama
RERANKING_ENABLED = env.bool('RERANKING_ENABLED', default=True)

# Включить multi-query retrieval (расширение запроса)
MULTI_QUERY_ENABLED = env.bool('MULTI_QUERY_ENABLED', default=True)

# ============================================================================
# Настройки управления контекстом
# ============================================================================

# Количество сообщений, после которых запускается суммаризация
SUMMARY_TRIGGER_MESSAGES = env.int('SUMMARY_TRIGGER_MESSAGES', default=20)

# Максимальное количество токенов для summary в контексте
SUMMARY_MAX_TOKENS = env.int('SUMMARY_MAX_TOKENS', default=400)

# Максимальное количество токенов для памяти пользователя в контексте
MEMORY_MAX_TOKENS = env.int('MEMORY_MAX_TOKENS', default=200)

# ============================================================================
# Настройки AI функций
# ============================================================================

# Включить генерацию suggested follow-up вопросов
SUGGESTIONS_ENABLED = env.bool('SUGGESTIONS_ENABLED', default=True)
