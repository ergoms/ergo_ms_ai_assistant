...
```python
from modules.ai_assistant.api.skills import BaseSkill, SkillResult
...
**Важно**: 
- Используйте относительные импорты (`...base` вместо `modules.ai_assistant.api.skills.base`)
...
```python
from modules.ai_assistant.api.skills import SkillRegistry
