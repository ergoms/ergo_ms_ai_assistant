...
from modules.ai_assistant.api.skills.integration import build_skills_prompt, execute_skill_from_llm_response
...
for response in test_responses:
    from modules.ai_assistant.api.skills.integration import parse_skill_call_from_response
